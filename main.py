...
class App(QWidget):
    ...
    def generatepasswd(self):
        ...
        our_string = str("Password: " + str(self.passwd))
        global copy_passwd
        self.copy_passwd = self.passwd
        self.password_label.setText(our_string)
    
        #Function slider value
    def slidervalue(self):
        global svalue
        svalue = self.slider.value()
        our_string = "Choose length of password: " + str(svalue) + " (min 1 - max 26)"
        self.howlong.setText(our_string)
